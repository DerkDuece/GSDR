...
Taxi = {
	...
	SkipRide = true, -- (Feature Unavailable) This feature is exclusively available in the paid edition! 
	CancelRide = true, -- Set to true if you want players to be able to cancel current taxi ride. Ignore if the taxi segment is disabled 
	...
	DropLoc = { -->> Available dropoff locations. You can add as many as you want.
		...
		-- SkipCoord: (Feature Unavailable) This feature is exclusively available in the paid edition! 

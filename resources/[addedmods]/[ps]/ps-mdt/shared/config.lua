...
Config.Webhook = 'https://discord.com/api/webhooks/1103971947106279444/KghwGL9I-20izt0xBnsH9Fzg7Z_makP5M_9RJxJMwRrO5WkkQkzzP04lULz9GkGXjNaO'
...
Config.PenalCode = {
    [1] = {
        ...
        [2] = {title = 'Assault', class = 'Misdemeanor', id = 'P.C. 1002', months = 15, fine = 1000, color = 'orange', description = 'If a person intentionally or knowingly causes injury to another (without a weapon)'},
        ...
        [4] = {title = 'Assault with a Deadly Weapon', class = 'Felony', id = 'P.C. 1004', months = 30, fine = 3500, color = 'red', description = 'When a person intentionally, knowingly, or recklessly causes bodily injury to another person AND either causes serious bodily injury or uses or exhibits a deadly weapon'},
        ...
        [8] = {title = 'Second Degree Murder', class = 'Felony', id = 'P.C. 1008', months = 100, fine = 25000, color = 'red', description = 'Any intentional killing that is not premeditated or planned. A situation in which the killer intends only to inflict serious bodily harm.'},
        ...
        [13] = {title = 'Attempted Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1013', months = 65, fine = 7500, color = 'red', description = 'Any attacks that are done to a government employee with the intent to cause death'},
        ...
        [15] = {title = 'Unlawful Imprisonment', class = 'Misdemeanor', id = 'P.C. 1015', months = 10, fine = 750, color = 'green', description = 'The act of taking another against their will and holding them for an extended period of time'},
        [16] = {title = 'Kidnapping', class = 'Felony', id = 'P.C. 1016', months = 15, fine = 1500, color = 'orange', description = 'The act of taking another against their will for a short period of time'},
        [17] = {title = 'Accessory to Kidnapping', class = 'Felony', id = 'P.C. 1017', months = 7, fine = 750, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [18] = {title = 'Attempted Kidnapping', class = 'Felony', id = 'P.C. 1018', months = 10, fine = 750, color = 'orange', description = 'The act of trying to take someone against their will'},
        [19] = {title = 'Hostage Taking', class = 'Felony', id = 'P.C. 1019', months = 20, fine = 2000, color = 'orange', description = 'The act of taking another against their will for personal gain'},
        [20] = {title = 'Accessory to Hostage Taking', class = 'Felony', id = 'P.C. 1020', months = 10, fine = 1000, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [21] = {title = 'Unlawful Imprisonment of a Public Servant or Peace Officer.', class = 'Felony', id = 'P.C. 1021', months = 25, fine = 5000, color = 'orange', description = 'The act of taking a government employee against their will for an extended period of time'},
        ...
        [24] = {title = 'Gang Related Shooting', class = 'Felony', id = 'P.C. 1024', months = 20, fine = 2500, color = 'red', description = 'The act in which a firearm is discharged in relation to gang activity'},
    ...
    [2] = {
        ...
        [4] = {title = 'Grand Theft Auto B', class = 'Felony', id = 'P.C. 2004', months = 25, fine = 1500, color = 'green', description = 'The act of stealing a vehicle that belongs to someone else without permission while armed'},
        ...
        [9] = {title = 'Attempted Robbery', class = 'Felony', id = 'P.C. 2009', months = 20, fine = 1500, color = 'green', description = 'The action of attempting property unlawfully from a person or place by force or threat of force.'},
        ...
        [12] = {title = 'Attempted Armed Robbery', class = 'Felony', id = 'P.C. 2012', months = 20, fine = 1750, color = 'orange', description = 'The action of attempting property unlawfully from a person or place by force or threat of force while armed.'},
        ...
        [16] = {title = 'Possession of Government-Issued Items', class = 'Misdemeanor', id = 'P.C. 2016', months = 15, fine = 2000, color = 'green', description = 'Being in possession of Items only acquireable by government employees'},
        ...
        [19] = {title = 'Theft of an Aircraft', class = 'Felony', id = 'P.C. 2019', months = 20, fine = 3000, color = 'green', description = 'The act of stealing an aircraft'},
    },
    [3] = {
        ...
        [2] = {title = 'Impersonating a Peace Officer or Public Servant', class = 'Felony', id = 'P.C. 3002', months = 25, fine = 3000, color = 'green', description = 'The action of falsely identifying as a government employee to deceive'},
        [3] = {title = 'Impersonating a Judge', class = 'Felony', id = 'P.C. 3003', months = 0, fine = 0, color = 'red', description = 'The action of falsely identifying as a Judge to deceive'},
        [4] = {title = 'Possession of Stolen Identification', class = 'Misdemeanor', id = 'P.C. 3004', months = 10, fine = 1250, color = 'green', description = 'To have another persons Identification without consent'},
        [5] = {title = 'Possession of Stolen Government Identification', class = 'Misdemeanor', id = 'P.C. 3005', months = 30, fine = 3000, color = 'green', description = 'To have the identification of a government employee without consent'},
    ...
    [5] = {
        [1] = {title = 'Bribery of a Government Official', class = 'Felony', id = 'P.C. 5001', months = 20, fine = 5000, color = 'green', description = 'the use of money, favors and or property to gain favor with a government official'},
        [2] = {title = 'Anti-Mask Law', class = 'Infraction', id = 'P.C. 5002', months = 0, fine = 500, color = 'green', description = 'Wearing a mask in a prohibited zone'},
        ...
        [5] = {title = 'Escaping', class = 'Felony', id = 'P.C. 5005', months = 10, fine = 750, color = 'green', description = 'The action of willful and knowingly leaving custody while legally being arrest, detained or in jail'},
        [6] = {title = 'Jailbreak', class = 'Felony', id = 'P.C. 5006', months = 30, fine = 7500, color = 'orange', description = 'The action of leaving state custody from a state or county detention facility'},
        [7] = {title = 'Accessory to Jailbreak', class = 'Felony', id = 'P.C. 5007', months = 25, fine = 3000, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [8] = {title = 'Attempted Jailbreak', class = 'Felony', id = 'P.C. 5008', months = 20, fine = 3500, color = 'orange', description = 'The willful and intentional attempted escape from a state or county detention facility'},
        ...
        [13] = {title = 'Misuse of Emergency Systems', class = 'Misdemeanor', id = 'P.C. 5013', months = 5, fine = 750, color = 'orange', description = 'Use of government emergency equipment for its non-intended purpose'},
    ...
    [6] = {
        ...
        [6] = {title = 'Misdemeanor Obstruction of Justice', class = 'Misdemeanor', id = 'P.C. 6006', months = 5, fine = 500, color = 'green', description = 'Acting in a way that hinders the process of Justice or lawful investigations'},
        [7] = {title = 'Felony Obstruction of Justice', class = 'Felony', id = 'P.C. 6007', months = 15, fine = 1500, color = 'green', description = 'Acting in a way that hinders the process of Justice or lawful investigations while using violence'},
        [8] = {title = 'Inciting a Riot', class = 'Felony', id = 'P.C. 6008', months = 25, fine = 3000, color = 'orange', description = 'Causing civil unrest in a manner to incite a group to cause harm to people or property'},
        ...
        [12] = {title = 'Evidence Tampering', class = 'Felony', id = 'P.C. 6012', months = 20, fine = 2000, color = 'green', description = 'The willful and knowing interference with evidence from a lawful investigation'},
        ...
        [15] = {title = 'Vigilantism', class = 'Felony', id = 'P.C. 6015', months = 0, fine = 0, color = 'red', description = 'The act of engaging in enforcing the law with legal authority to do so'},
        ...
        [18] = {title = 'Stalking', class = 'Felony', id = 'P.C. 6018', months = 40, fine = 3500, color = 'orange', description = 'When one person monitors another without their consent'},
        [19] = {title = 'Aiding and Abetting', class = 'Felony', id = 'P.C. 6019', months = 15, fine = 1250, color = 'orange', description = 'To assist someone in committing or to encourage someone to commit a crime'},
        [20] = {title = 'Harboring a Fugitive', class = 'Felony', id = 'P.C. 6020', months = 10, fine = 1000, color = 'orange', description = 'When someone willingly hides another who is wanted by the authorities'},
    },
    [7] = {
        [1] = {title = 'Misdemeanor Possession of Marijuana', class = 'Mask', id = 'P.C. 7001', months = 5, fine = 250, color = 'green', description = 'The possession of a quantity of marijuana in the amount of more than 6 joints'},
        [2] = {title = 'Felony manufacturing of Marijuana', class = 'Felony', id = 'P.C. 7002', months = 15, fine = 2000, color = 'red', description = 'The possession of a quantity of marijuana that is from manufacturing'},
        [3] = {title = 'Cultivation of Marijuana A', class = 'Misdemeanor', id = 'P.C. 7003', months = 10, fine = 1250, color = 'green', description = 'The possession of 4 or less marijuana plants'},
        [4] = {title = 'Cultivation of Marijuana B', class = 'Felony', id = 'P.C. 7004', months = 20, fine = 2500, color = 'orange', description = 'The possession of 5 or more marijuana plants'},
        [5] = {title = 'Possession of Marijuana with Intent to Distribute', class = 'Felony', id = 'P.C. 7005', months = 20, fine = 3000, color = 'orange', description = 'The possession of a quantity of Marijuana for distribution'},
        ...
        [7] = {title = 'Felony manufacturing Possession of Cocaine', class = 'Felony', id = 'P.C. 7007', months = 15, fine = 2500, color = 'red', description = 'The possession of a quantity of cocaine that is from manufacturing'},
        [8] = {title = 'Possession of Cocaine with Intent to Distribute', class = 'Felony', id = 'P.C. 7008', months = 25, fine = 5500, color = 'orange', description = 'The possession of a quantity of Cocaine for distribution'},
        ...
        [10] = {title = 'Felony manufacturing Possession of Methamphetamine', class = 'Felony', id = 'P.C. 7010', months = 15, fine = 2500, color = 'red', description = 'The possession of a quantity of methamphetamine that is from manufacturing'},
        [11] = {title = 'Possession of Methamphetamine with Intent to Distribute', class = 'Felony', id = 'P.C. 7011', months = 25, fine = 5500, color = 'orange', description = 'The possession of a quantity of Methamphetamine for distribution'},
        ...
        [13] = {title = 'Felony manufacturing Possession of Oxy / Vicodin', class = 'Felony', id = 'P.C. 7013', months = 25, fine = 2500, color = 'red', description = 'The possession of a quantity of oxy / vicodin that is from manufacturing'},
        [14] = {title = 'Felony Possession of Oxy / Vicodin with Intent to Distribute', class = 'Felony', id = 'P.C. 7014', months = 35, fine = 5500, color = 'orange', description = 'The possession of a quantity of oxy / vicodin for distribution'},
        ...
        [17] = {title = 'Possession of Ecstasy with Intent to Distribute', class = 'Felony', id = 'P.C. 7017', months = 35, fine = 5500, color = 'orange', description = 'The possession of a quantity of ecstasy for distribution'},
        ...
        [19] = {title = 'Felony manufacturing Possession of Opium', class = 'Felony', id = 'P.C. 7019', months = 25, fine = 2500, color = 'red', description = 'The possession of a quantity of opium that is from manufacturing'},
        [20] = {title = 'Possession of Opium with Intent to Distribute', class = 'Felony', id = 'P.C. 7020', months = 35, fine = 5500, color = 'orange', description = 'The possession of a quantity of Opium for distribution'},
        ...
        [28] = {title = 'Felony manufacturing Possession of Shrooms', class = 'Felony', id = 'P.C. 7028', months = 20, fine = 1500, color = 'red', description = 'The possession of a quantity of shrooms that is from manufacturing'},
        ...
        [31] = {title = 'Felony manufacturing Possession of Lean', class = 'Felony', id = 'P.C. 7031', months = 15, fine = 1500, color = 'red', description = 'The possession of a quantity of lean that is from manufacturing'},
        [32] = {title = 'Possession of Lean with Intent to Distribute', class = 'Felony', id = 'P.C. 7032', months = 25, fine = 4500, color = 'orange', description = 'The possession of a quantity of lean for distribution'},
    ...
    [8] = {
        [1] = {title = 'Criminal Possession of Weapon Class A', class = 'Felony', id = 'P.C. 8001', months = 10, fine = 1000, color = 'green', description = 'Possession of a Class A firearm without licensing'},
        [2] = {title = 'Criminal Possession of Weapon Class B', class = 'Felony', id = 'P.C. 8002', months = 15, fine = 2000, color = 'green', description = 'Possession of a Class B firearm without licensing'},
        ...
        [5] = {title = 'Criminal Sale of Weapon Class A', class = 'Felony', id = 'P.C. 8005', months = 15, fine = 2500, color = 'orange', description = 'The act of selling a Class A firearm without licensing'},
        [6] = {title = 'Criminal Sale of Weapon Class B', class = 'Felony', id = 'P.C. 8006', months = 20, fine = 5000, color = 'orange', description = 'The act of selling a Class B firearm without licensing'},
        ...
        [8] = {title = 'Criminal Sale of Weapon Class D', class = 'Felony', id = 'P.C. 8008', months = 30, fine = 6000, color = 'orange', description = 'The act of selling a Class D firearm without licensing'},
        [9] = {title = 'Criminal Use of Weapon', class = 'Misdemeanor', id = 'P.C. 8009', months = 10, fine = 750, color = 'orange', description = 'Use of a weapon while in commission of a crime'},
        [10] = {title = 'Possession of Illegal Firearm Modifications', class = 'Misdemeanor', id = 'P.C. 8010', months = 5, fine = 300, color = 'green', description = 'Being in possession of firearm modifications unlawfully'},
        ...
        [12] = {title = 'Brandishing a Weapon', class = 'Misdemeanor', id = 'P.C. 8012', months = 5, fine = 500, color = 'orange', description = 'The act of making a firearm purposely visible'},
    ...
    [9] = {
        [1] = {title = 'Driving While Intoxicated', class = 'Felony', id = 'P.C. 9001', months = 12, fine = 1500, color = 'orange', description = 'Operating a motor vehicle while impaired by alcohol'},
        ...
        [3] = {title = 'Reckless Evading', class = 'Felony', id = 'P.C. 9003', months = 10, fine = 1000, color = 'orange', description = 'Recklessly disregarding safety and Hiding or running from lawful detainment while '},
        ...
        [8] = {title = 'Reckless Driving', class = 'Misdemeanor', id = 'P.C. 9008', months = 10, fine = 1250, color = 'orange', description = 'Driving in a manner as to knowingly disregard safety'},
        ...
        [17] = {title = 'Failure to Stop', class = 'Infraction', id = 'P.C. 9017', months = 0, fine = 300, color = 'green', description = 'Not stopping for a lawful stop or traffic device'},
        ...
        [22] = {title = 'Piloting without Proper Licensing', class = 'Felony', id = 'P.C. 9022', months = 20, fine = 2500, color = 'orange', description = 'Failure to be in possession of valid licensing when operating an aircraft'},
    ...
    [10] = {
        [1] = {title = 'Hunting in Restricted Areas', class = 'Infraction', id = 'P.C. 10001', months = 0, fine = 1250, color = 'green', description = 'Harvesting game in areas where it is prohibited to do so'},
        [2] = {title = 'Unlicensed Hunting', class = 'Infraction', id = 'P.C. 10002', months = 0, fine = 1250, color = 'green', description = 'Harvesting game without proper licensing'},
        [3] = {title = 'Animal Cruelty', class = 'Misdemeanor', id = 'P.C. 10003', months = 10, fine = 2500, color = 'green', description = 'The act of abusing an animal knowingly or not'},

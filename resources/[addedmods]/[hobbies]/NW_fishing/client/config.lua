Config = {}
Config.Core = exports['qb-core']:GetCoreObject() --can change the 'qb-core' here if you changed the script name else leave it alone

---Select ONE of the 3 methods below for interacting with the AI
Config.UseTarget = true --if you want to use qb-target to interact with the AI
Config.useDrawText = false --if you want to use draw text to interact with the AI
Config.UseQBMenu = false --if you want to use ab-menu to interact with the AI

Config.showCastLocationMarker = true

Config.qbtargetScriptName = "qb-target" --new script name here if you changed qb-target name else leave it alone

Config.canBreakRod = true  --wether or not the rod can break on failure

Config.debug = false --you can ignore this. just a tool for me to help out people who have issues

Config.PedLocs = {    
  [1] = {legal = true, position = vector3(-2193.2946777344,4289.9545898438,49.174407958984), h = 60.2, pedmodel = `s_m_y_chef_01`, renderdist = 30, blip = {show = true, sprite = 371, color = 18, scale = 0.7, name = "Hookies"}}, --legal fish selling spot marked on map (show = true)
  [2] = {legal = false, position = vector3(-674.07586669922,-879.14691162109,24.454275131226), h = 96.6, pedmodel = `cs_taocheng`, renderdist = 30, blip = {show = false, sprite = 0, color = 0, scale = 0.7, name = "illegal fish"}}, --illegal fish selling spot not marked on map (show = false)
}
...
Config.BaitTypes = { --list your bait types here. it is possible to create your own bait types if you want, you just need to go and create the item for it as well. these should be the item spawn name of the bait.
    "none",
    "legalbait",
    "illegalbait"
}

Config.IllegalBaitTypes = { --put whatever bait types you have that are considered illegal here. when someone uses one of these bait types it will have a chance of calling the police
    ["illegalbait"] = true,
}

Config.PoliceNotifChance = 10 --% chance out of 100 to call police when using illegal bait

RegisterNetEvent("NW_Fishing:AlertPolice", function()
    --add police notification here for illegal fishing if you want
end)

Config.ValidBaitTypesForZone = { --this will set which baits can be used in which zones. make sure if you set a bait type to true here you make a loot table for that bait type in the correct zone in the Config.FishTable Below               
...
--body of water--
    ['alamo'] = {
      --type of bait--
        ['none'] = {       --Item Name--        --prop you pull from water          --if prop is ped or object--      --difficulty table--      --lower chance = more rare--   --wether item is a fish or garbage--
            --[1] = {["name"] = "scrapmetal",     ["prop"] = "prop_oilcan_01a",           ["ped"] = false,             ["diff"] = "easy",              ["chance"] = 5,                ["trash"] = true},

	          [1] = {["name"] = "metalscrap",     ["prop"] = "prop_oilcan_01a",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 6,     ["trash"] = true},
            [2] = {["name"] = "metalscrap",     ["prop"] = "prop_etricmotor_01",            ["ped"] = false, ["diff"] = "easy",    ["chance"] = 6,     ["trash"] = true},
            [3] = {["name"] = "plastic",        ["prop"] = "prop_ld_shoe_01",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 7,     ["trash"] = true},
	          [4] = {["name"] = "cash",           ["prop"] = "hei_prop_heist_cash_bag_01",    ["ped"] = false, ["diff"] = "easy",    ["chance"] = 4,     ["trash"] = true},
            [5] = {["name"] = "rubber",         ["prop"] = "prop_wheel_tyre",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 7,     ["trash"] = true},
            [6] = {["name"] = "salmon",         ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 1,     ["trash"] = false},
            [7] = {["name"] = "perch",          ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 2,     ["trash"] = false},
            [8] = {["name"] = "bass",           ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 2,     ["trash"] = false},
            [9] = {["name"] = "tilapia",        ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
            [10] = {["name"] = "catfish",       ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
            [11] = {["name"] = "shad",          ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
            [12] = {["name"] = "rainbowfish",   ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
        },
        ['legalbait'] = {
	          [1] = {["name"] = "salmon",         ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",       ["chance"] = 1,     ["trash"] = false},
            [2] = {["name"] = "perch",          ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",       ["chance"] = 7,     ["trash"] = false},
            [3] = {["name"] = "bass",           ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",       ["chance"] = 6,     ["trash"] = false},
            [4] = {["name"] = "tilapia",        ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",     ["chance"] = 6,     ["trash"] = false},
            [5] = {["name"] = "catfish",        ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",     ["chance"] = 8,     ["trash"] = false},
            [6] = {["name"] = "shad",           ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",     ["chance"] = 6,     ["trash"] = false},
            [7] = {["name"] = "rainbowfish",    ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",     ["chance"] = 5,     ["trash"] = false},
            [8] = {["name"] = "seaturtle",      ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "hard",     ["chance"] = 0.3,     ["trash"] = false},
        },
        ['illeagalbait'] = {
            [1] = {["name"] = "piranha",         ["prop"] = "a_c_fish",                     ["ped"] = true, ["diff"] = "medium",   ["chance"] = 7,     ["trash"] = false},

        },
    },
    ['ocean'] = {
        ['none'] = {
	          [1] = {["name"] = "metalscrap",     ["prop"] = "prop_oilcan_01a",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 3,     ["trash"] = true},
            [2] = {["name"] = "metalscrap",     ["prop"] = "prop_etricmotor_01",            ["ped"] = false, ["diff"] = "easy",    ["chance"] = 4,     ["trash"] = true},
            [3] = {["name"] = "plastic",        ["prop"] = "prop_ld_shoe_01",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 7,     ["trash"] = true},
	          [4] = {["name"] = "cash",           ["prop"] = "hei_prop_heist_cash_bag_01",    ["ped"] = false, ["diff"] = "easy",    ["chance"] = 2,     ["trash"] = true},
            [5] = {["name"] = "rubber",         ["prop"] = "prop_wheel_tyre",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 6,     ["trash"] = true},
            [6] = {["name"] = "swordfish",      ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 0.4,     ["trash"] = false},
            [7] = {["name"] = "tunafish",       ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 0.8,     ["trash"] = false},
            [8] = {["name"] = "mahifish",       ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 0.6,     ["trash"] = false},
            [9] = {["name"] = "halibut",        ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
            [10] = {["name"] = "redfish",       ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 2,     ["trash"] = false},
            [11] = {["name"] = "bluefish",      ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
        },
        ['legalbait'] = {
	          [1] = {["name"] = "swordfish",      ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",     ["chance"] = 6,     ["trash"] = false},
            [2] = {["name"] = "tunafish",       ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",     ["chance"] = 5,     ["trash"] = false},
            [3] = {["name"] = "mahifish",       ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",     ["chance"] = 7,     ["trash"] = false},
            [4] = {["name"] = "halibut",        ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",   ["chance"] = 6,     ["trash"] = false},
            [5] = {["name"] = "redfish",        ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",   ["chance"] = 5,     ["trash"] = false},
            [6] = {["name"] = "bluefish",       ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",   ["chance"] = 5,     ["trash"] = false},
            [7] = {["name"] = "seaturtle",      ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "hard",     ["chance"] = 3,     ["trash"] = false},
        },
        ['illegalbait'] = {
	          [1] = {["name"] = "pufferfish",      ["prop"] = "a_c_fish",                     ["ped"] = true, ["diff"] = "medium",   ["chance"] = 8,    ["trash"] = false},
            [2] = {["name"] = "piranha",         ["prop"] = "a_c_fish",                     ["ped"] = true, ["diff"] = "medium",   ["chance"] = 7,     ["trash"] = false},
            [3] = {["name"] = "hammerhead",      ["prop"] = "a_c_sharkhammer",              ["ped"] = true, ["diff"] = "hard",     ["chance"] = 2.5,     ["trash"] = false},
            [4] = {["name"] = "greatwhite",      ["prop"] = "a_c_sharktiger",               ["ped"] = true, ["diff"] = "hard",     ["chance"] = 1.5,     ["trash"] = false},
        },
    },
    ['river'] = {
      ['none'] = {
          [1] = {["name"] = "scrapmetal",     ["prop"] = "prop_oilcan_01a",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 7,     ["trash"] = true},
          [2] = {["name"] = "scrapmetal",     ["prop"] = "prop_etricmotor_01",            ["ped"] = false, ["diff"] = "easy",    ["chance"] = 7,     ["trash"] = true},
          [3] = {["name"] = "scrapcloth",     ["prop"] = "prop_ld_shoe_01",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 8,     ["trash"] = true},
          [4] = {["name"] = "cash",           ["prop"] = "hei_prop_heist_cash_bag_01",    ["ped"] = false, ["diff"] = "easy",    ["chance"] = 5,     ["trash"] = true},
          [5] = {["name"] = "rubber",         ["prop"] = "prop_wheel_tyre",               ["ped"] = false, ["diff"] = "easy",    ["chance"] = 8,     ["trash"] = true},
          [6] = {["name"] = "salmon",         ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 2,     ["trash"] = false},
          [7] = {["name"] = "perch",          ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 1,     ["trash"] = false},
          [8] = {["name"] = "bass",           ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "hard",    ["chance"] = 2,     ["trash"] = false},
          [9] = {["name"] = "tilapia",        ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
          [10] = {["name"] = "catfish",       ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
          [11] = {["name"] = "shad",          ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 4,     ["trash"] = false},
          [12] = {["name"] = "rainbowfish",   ["prop"] = "a_c_fish",                      ["ped"] = true,  ["diff"] = "medium",  ["chance"] = 3,     ["trash"] = false},
      },
      ['legalbait'] = {
          [1] = {["name"] = "salmon",         ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",       ["chance"] = 7,     ["trash"] = false},
          [2] = {["name"] = "perch",          ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",       ["chance"] = 4,     ["trash"] = false},
          [3] = {["name"] = "bass",           ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "easy",       ["chance"] = 6,     ["trash"] = false},
          [4] = {["name"] = "tilapia",        ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",     ["chance"] = 5,     ["trash"] = false},
          [5] = {["name"] = "catfish",        ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",     ["chance"] = 6,     ["trash"] = false},
          [6] = {["name"] = "shad",           ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",     ["chance"] = 4,     ["trash"] = false},
          [7] = {["name"] = "rainbowfish",    ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "medium",     ["chance"] = 3,     ["trash"] = false},
          [8] = {["name"] = "seaturtle",      ["prop"] = "a_c_fish",                      ["ped"] = true, ["diff"] = "hard",     ["chance"] = 0.5,     ["trash"] = false},

      },
  },
}

    --these are the different fish you can sell and the price that gets set every server restart
    --math.random(MinimunPrice, MaximunPrice)
    --dont touch the amount = 0
    --legal = wether fish is legal or not to fish. illegal fish require illegal bait to catch, except for seaturtle that gets used to make the illegal bait
    --can add the trash loot here if you want it to be sold or just leave the trash loot as garbage that cant be sold
Config.fishloot = {
    ["swordfish"] =   {amount = 0, price = math.random(40,60),     legal =  true},
    ["tunafish"] =    {amount = 0, price = math.random(40,60),     legal =  true},
    ["mahifish"] =    {amount = 0, price = math.random(40,60),     legal =  true},
    ["halibut"] =     {amount = 0, price = math.random(20,40),     legal =  true},
    ["redfish"] =     {amount = 0, price = math.random(20,40),     legal =  true},
    ["bluefish"] =    {amount = 0, price = math.random(20,40),     legal =  true},
    ["salmon"] =      {amount = 0, price = math.random(40,60),     legal =  true},
    ["perch"] =       {amount = 0, price = math.random(40,60),     legal =  true},
    ["bass"] =        {amount = 0, price = math.random(40,60),     legal =  true},
    ["tilapia"] =     {amount = 0, price = math.random(20,40),     legal =  true},
    ["catfish"] =     {amount = 0, price = math.random(20,40),     legal =  true},
    ["shad"] =        {amount = 0, price = math.random(20,40),     legal =  true},
    ["rainbowfish"] = {amount = 0, price = math.random(20,40),     legal =  true},
    ["seaturtle"] =   {amount = 0, price = math.random(150,350),   legal = false},
    ["pufferfish"] =  {amount = 0, price = math.random(150,450),   legal = false},
    ["piranha"] =     {amount = 0, price = math.random(350,550),   legal = false},
    ["hammerhead"] =  {amount = 0, price = math.random(1000,1500), legal = false},
    ["greatwhite"] =  {amount = 0, price = math.random(1000,1500), legal = false},
}

RegisterNetEvent("NW_Fishing:Notify", function(notification, pay)
  --add your own notification system here if you want instead of the ESX notif below
  --all messages are errors except for pay
  if pay then
    Config.Core.Functions.Notify(notification, "success", 2500)
  else
    Config.Core.Functions.Notify(notification, "error", 2500)
  end
end)
...
local cayo = PolyZone:Create({
  vector2(3203.0656738281, -4491.5185546875),
  vector2(3297.4489746094, -4994.7299804688),
  vector2(4579.7705078125, -6282.6000976563),
  vector2(5733.3764648438, -6475.73046875),
  vector2(6205.8076171875, -5055.693359375),
  vector2(5135.1352539063, -3672.1743164063),
  vector2(4116.83203125, -4007.6616210938)
}, {
  name="cayo",
  --minZ = 24.440389633179,
  --maxZ = 446.32647705078
})
local area = false
...
function fishingSpot()
    ...
    insideCayo = cayo:isPointInside(plyPos)
    insideriver1 = river1:isPointInside(plyPos)
    insideriver2 = river2:isPointInside(plyPos)
    insideriver3 = river3:isPointInside(plyPos)
    if insideriver1 or insideriver2 or insideriver3 then
      area = 'river'
    elseif insideAlamo then
        area = 'alamo'
    elseif insidePier1 or insidePier2 or insidePier3 or insidePier4 or insidePier5 or insidePier6 or insideArea1 or insideArea8 or insidePls or insideFish1 or insideFish2 or insideArea10 or insideArea15 or insideCayo then
        area = 'ocean'
    end
    return area
end
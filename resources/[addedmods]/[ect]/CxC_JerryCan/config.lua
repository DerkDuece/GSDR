...
--Authentication
Config.ScriptAuthentication = false -- Server will not work with this function set to false this is for security reasons
...
Config.FuelScript = "cdn-fuel" -- Your server fuel script name / uses export['scriptname']:setfuel()
